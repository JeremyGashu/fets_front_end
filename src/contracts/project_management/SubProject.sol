...
contract SubProject {
    ...
    function getSubProjectById(uint256 _id)
        public
        view
        returns (
            uint256 id,
    ...
    */
    function getSubProjectCount(uint256 _id)
        internal
        view
    ...
    */
    function getSubProjectsListByProjectId(uint256 _id)
        public
        view
        returns (SubProjectInfo[] memory)
    {
